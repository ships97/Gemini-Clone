...
const DashboardPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-8 px-2">
      <div className="w-full border border-red-500 max-w-2xl bg-white dark:bg-gray-900 rounded-2xl shadow-2xl px-8 mb-8 border border-gray-200 dark:border-gray-700">
        <h1 className="text-3xl font-bold my-6 text-blue-700 dark:text-blue-300 text-center tracking-tight">Your Chatrooms</h1>
